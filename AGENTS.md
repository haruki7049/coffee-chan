...
- **Naming Conventions**: Follow repository naming standards defined in [`docs/NAMING.md`](docs/NAMING.md). In particular, comptime type parameters must always be a single uppercase character (e.g., `comptime T: type`).
