//! Musical phrase 0003 composition and loader functions.
...
/// Converts phrase 0003 notes into Note events.
pub fn toEvents(
    comptime T: type,
    comptime S: type,
...
/// Converts phrase 0003 notes transposed by semitones into Note events.
...
/// Synthesizes and loads phrase 0003 notes onto a sequencer track.
pub fn load(
    comptime T: type,
    comptime G: type,
    comptime S: type,
...
/// Synthesizes and loads phrase 0003 notes transposed by semitones onto a sequencer track.
...
/// Renders phrase 0003 into a standalone lightmix.Wave(T).
pub fn gen(
    comptime T: type,
    comptime G: type,
    comptime S: type,
