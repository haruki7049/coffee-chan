//! Musical phrase 0006 composition and loader functions.
...
/// Converts phrase 0006 notes into Note events.
pub fn toEvents(
    comptime T: type,
    comptime S: type,
...
/// Converts phrase 0006 notes transposed by semitones into Note events.
...
/// Synthesizes and loads phrase 0006 notes onto a sequencer track.
pub fn load(
    comptime T: type,
    comptime G: type,
    comptime S: type,
...
/// Synthesizes and loads phrase 0006 notes transposed by semitones onto a sequencer track.
...
/// Synthesizes and loads phrase 0006 notes across an instrument's strings.
...
/// Synthesizes and loads phrase 0006 notes transposed by semitones across an instrument's strings.
...
/// Renders phrase 0006 into a standalone lightmix.Wave(T).
pub fn gen(
    comptime T: type,
    comptime G: type,
    comptime S: type,
...
test "loadInstrument phrase 0006 across strings" {
    const synthesizers = @import("synthesizers");
    const allocator = std.testing.allocator;
